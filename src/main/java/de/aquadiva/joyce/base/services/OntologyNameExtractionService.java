...
public class OntologyNameExtractionService implements IOntologyNameExtractionService {
	...
	public void extractNames() {
		...
		String[] cmdarray = new String[] {"java", "-jar", "tools" + File.separatorChar + jarfile, "-eci", ontosDir.getAbsolutePath(),
				ontosInfoDir.getAbsolutePath(), classNamesDir.getAbsolutePath(), "false", "false"};
